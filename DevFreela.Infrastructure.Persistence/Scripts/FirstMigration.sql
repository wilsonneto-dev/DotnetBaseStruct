...
CREATE TABLE [UserSkills] (
    ...
    CONSTRAINT [FK_UserSkills_Skills_IdSkill] FOREIGN KEY ([IdSkill]) REFERENCES [Skills] ([Id]) ON DELETE NO ACTION,
    CONSTRAINT [FK_UserSkills_Users_IdUser] FOREIGN KEY ([IdUser]) REFERENCES [Users] ([Id]) ON DELETE NO ACTION
);
...
CREATE INDEX [IX_UserSkills_IdUser] ON [UserSkills] ([IdUser]);

GO

INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20201114194938_FirstMigration', N'3.1.10');
